CLS
@ECHO OFF
ECHO  *** OPTIMIZA TU CONEXION *** 
ECHO.
ECHO  
ECHO  ------------------------------------------
ECHO  Letra "y" para optimizar  Internet
ECHO  Letra "q" para Deshabilitar el ancho de banda reservado para windows
...
CLS
ECHO  * Exito - PRESIONA ENTER PARA SALIR *
GOTO SUCCESS
...
CLS
ECHO  * Se han restablecido correctamente los valores por defecto - PRESIONA ENTER PARA SALIR *
GOTO SUCCESS
...
:CANCEL
CLS 
ECHO   * CANCELADO - PRESIONA ENTER PARA SALIR *
ECHO.
ECHO.
@PAUSE
EXIT
